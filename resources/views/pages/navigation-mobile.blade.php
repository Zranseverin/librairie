...
<nav class="mobile-nav">
  <div class="mn-item" onclick="showPage('home')">
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
    <span>Accueil</span>
  </div>
  <div class="mn-item" onclick="showPage('catalogue')">
  ...
  <div class="mn-item" onclick="showPage('search');runSearch('');document.getElementById('searchPageInput').value='';document.getElementById('searchPageInput').focus()">
  ...
  <div class="mn-item" onclick="showPage('cart')" style="position:relative">
    ...
    <span class="cart-badge" id="badge8" style="position:absolute;top:2px;right:14px;font-size:9px">0</span>
    <span>Panier</span>
  </div>
  <div class="mn-item" onclick="showPage('account')">
